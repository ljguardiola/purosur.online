...
export const messages = defineMessages("es-AR", (f) => ({
  ...
  settings: {
    ...
    branch: {
      ...
      defectiveReturnDaysLabel: "Cambio con defecto",
      daysUnit: "días",
      defectiveFloorHelper:
      ...
      timezoneFieldError: "Ingresá una zona horaria válida.",
      daysFieldError: "Ingresá un número entero de 0 días o más.",
      defectiveDaysFieldError: "No puede ser menor a 180 días.",
    },
  },
  help: {
    areaLabel: "Ayuda",
